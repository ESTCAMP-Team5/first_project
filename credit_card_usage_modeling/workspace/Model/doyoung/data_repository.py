...
# repo = create_data_repository("mysql")

# 2. 직접 파라미터 전달 방식
# repo = create_data_repository("mysql", host="localhost", username="root", password="your-password")

# 3. Mock 데이터 사용
# repo = create_data_repository("mock")